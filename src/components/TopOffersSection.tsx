      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
          ...
          <Link href="/CarDetails">
            <div className="bg-white rounded-lg shadow-sm overflow-hidden relative cursor-pointer">
              ...
              <div className="p-3 sm:p-4">
                <div className="flex items-center justify-between text-xs text-gray-500 mb-3">
                  ...
                  <div className="flex space-x-1 sm:space-x-2">
                    ...
                    <button className="icon-btn">
                      <PiBellRingingLight className="icon" />
                    </button>
                    <button className="icon-btn">
          ...
          <div className="flex flex-col space-y-4 h-full">
            {topOffers.slice(1).map((offer) => (
              <Link href="/CarDetails" key={offer.id}>
                <div className="bg-white rounded-lg shadow-sm overflow-hidden flex flex-col sm:flex-row flex-1 min-h-0 cursor-pointer">
